...
class ResNet18Confidence(nn.Module):
    ...
    def forward(self, input, depth):
        ...
        x = nn.functional.interpolate(x, size=(240, 320), mode='bilinear')

        enc1 = nn.functional.interpolate(enc1, size=(240, 320), mode='bilinear')
        dec1 = nn.functional.interpolate(dec1, size=(240, 320), mode='bilinear')
